      ...
      <div className="sticky top-0 z-40 w-full border-b border-zinc-800/80 bg-[rgba(12,12,14,0.7)] backdrop-blur-xl overflow-x-hidden">
        <div className="mx-auto flex w-full max-w-full items-center justify-between px-2 sm:px-4 py-3">
          ...
          <div className="hidden sm:flex items-center gap-2">
            <button className={`group inline-flex items-center gap-2 rounded-xl px-3 py-2 text-sm ${route === PAGES.HOME ? "bg-zinc-800 text-white" : "text-zinc-300 hover:text-white hover:bg-zinc-800/60"}`} onClick={() => { setSelectedBook(null); setRoute(PAGES.HOME); window.scrollTo({ top: 0, behavior: "smooth" }); }}><Home size={16} className="opacity-90" />Hjem</button>
            <button className={`group inline-flex items-center gap-2 rounded-xl px-3 py-2 text-sm ${route === PAGES.BOOKS ? "bg-zinc-800 text-white" : "text-zinc-300 hover:text-white hover:bg-zinc-800/60"}`} onClick={() => { setSelectedBook(null); setRoute(PAGES.BOOKS); window.scrollTo({ top: 0, behavior: "smooth" }); }}><Library size={16} className="opacity-90" />Bøker</button>
            <button className={`group inline-flex items-center gap-2 rounded-xl px-3 py-2 text-sm ${route === PAGES.LORE ? "bg-zinc-800 text-white" : "text-zinc-300 hover:text-white hover:bg-zinc-800/60"}`} onClick={() => { setSelectedBook(null); setRoute(PAGES.LORE); window.scrollTo({ top: 0, behavior: "smooth" }); }}><Scroll size={16} className="opacity-90" />Lore</button>
            <button className={`group inline-flex items-center gap-2 rounded-xl px-3 py-2 text-sm ${route === PAGES.NEWS ? "bg-zinc-800 text-white" : "text-zinc-300 hover:text-white hover:bg-zinc-800/60"}`} onClick={() => { setSelectedBook(null); setRoute(PAGES.NEWS); window.scrollTo({ top: 0, behavior: "smooth" }); }}><BookOpen size={16} className="opacity-90" />Nyheter</button>
            <button className={`group inline-flex items-center gap-2 rounded-xl px-3 py-2 text-sm ${route === PAGES.ABOUT ? "bg-zinc-800 text-white" : "text-zinc-300 hover:text-white hover:bg-zinc-800/60"}`} onClick={() => { setSelectedBook(null); setRoute(PAGES.ABOUT); window.scrollTo({ top: 0, behavior: "smooth" }); }}><Info size={16} className="opacity-90" />Om</button>
            <button className={`group inline-flex items-center gap-2 rounded-xl px-3 py-2 text-sm ${route === PAGES.CONTACT ? "bg-zinc-800 text-white" : "text-zinc-300 hover:text-white hover:bg-zinc-800/60"}`} onClick={() => { setSelectedBook(null); setRoute(PAGES.CONTACT); window.scrollTo({ top: 0, behavior: "smooth" }); }}><Mail size={16} className="opacity-90" />Kontakt</button>
            <button className={`group inline-flex items-center gap-2 rounded-xl px-3 py-2 text-sm ${route === PAGES.AUTHOR ? "bg-zinc-800 text-white" : "text-zinc-300 hover:text-white hover:bg-zinc-800/60"}`} onClick={() => { setSelectedBook(null); setRoute(PAGES.AUTHOR); window.scrollTo({ top: 0, behavior: "smooth" }); }}><User size={16} className="opacity-90" />Forfatter</button>
          </div>
        </div>
      </div>
  );
