    ...
    <div className="sticky top-0 z-40 w-full border-b border-zinc-800/80 bg-[rgba(12,12,14,0.7)] backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link to={PAGES.BOOKS} icon={Library}>
            Bøker
          </Link>
          <Link to={PAGES.LORE} icon={Scroll}>
            Lore
          </Link>
          <Link to={PAGES.NEWS} icon={BookOpen}>
            Nyheter
          </Link>
          <Link to={PAGES.ABOUT} icon={Info}>
            Om
          </Link>
          <Link to={PAGES.CONTACT} icon={Mail}>
            Kontakt
          </Link>
          <Link to={PAGES.AUTHOR} icon={User}>
            Forfatter
          </Link>
